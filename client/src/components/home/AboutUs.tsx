export const AboutUs = () => {
  return (
    <section className="w-full bg-white py-16">
      <div className="mx-auto grid max-w-4xl grid-cols-1 gap-10 px-6 md:grid-cols-2 md:items-start">
        {/* LEFT CONTENT */}
        <div>
          <h2 className="text-4xl font-bold tracking-wide text-[#0b1a33]">
            ABOUT US
          </h2>
          ...
          <p className="mt-2 text-sm leading-relaxed text-[#1f2a44]">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm mb-2 font-semibold uppercase tracking-wide text-orange-500">
