const AdmissionDocuments = () => {
  return (
    <section className="w-max-6xl h-max-6xl bg-[#eaf7f8] py-20">
      <div className="mx-auto max-w-6xl px-8 lg:px-16">
        {/* DOCUMENTS REQUIRED */}
        <h2 className="text-md  font-bold text-[#0b1b2b] mb-6">
          DOCUMENTS REQUIRED FOR NEW ADMISSION
        </h2>

        <ul className="list-disc pl-6 text-[#1f3b5b] text-sm mb-10">
        ...
        {/* OTHER DETAILS */}
        <h2 className="text-md font-bold text-[#0b1b2b] mb-6">OTHER DETAILS</h2>

        <h3 className="font-semibold text-[#0b1b2b] mb-2 text-sm">
          Swimming requirement
        </h3>

        <div className=" text-[#1f3b5b] text-sm leading-relaxed">
          <p className="mb-4">
